...
if menu == "🏠 Beranda":
    ...
    ✅ Membandingkan hasil COD dengan baku mutu PP Nomor 22 Tahun 2021

    ✅ Menentukan kesesuaian kualitas air berdasarkan kelas air
    ...
    st.latex(
        r"COD=\frac{(A-B)\times N \times 8000}{V}"
    )
